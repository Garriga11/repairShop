  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="bg-white shadow-2xl rounded-xl p-10 flex flex-col items-center w-full max-w-md">
        ...
        <h1 className="text-3xl font-bold text-blue-700 mb-2 text-center">Secured By Next-Auth</h1>
        <p className="text-gray-600 mb-8 text-center">Welcome! Please log in to access your dashboard.</p>
